---
title: "kube-bench CIS Benchmark 4개 FAIL → Kubernetes Audit Log 구현과 .bak 파일 트러블슈팅"
...
cover:
  image: "cover.jpg"
  alt: "kube-bench CIS Benchmark 4개 FAIL → Kubernetes Audit Log 구현과 .bak 파일 트러블슈팅"
  relative: true
---
