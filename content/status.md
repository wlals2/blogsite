...
> 기간: 2026-04-20 ~ 2026-04-23 (3일간)
> 생성: 2026-04-23 07:00:06
...
- **비정상 Pod**:
  - 없음
- **재시작 많은 Pod (5회 이상)**:
  - calico-system/calico-node-lnqsx 재시작:8회
  - calico-system/calico-typha-ddf4dbbdd-7zxhc 재시작:8회
  - calico-system/csi-node-driver-5bjnz 재시작:8회
  - calico-system/csi-node-driver-cd9sm 재시작:8회
  - calico-system/csi-node-driver-nfjnn 재시작:16회
  - calico-system/csi-node-driver-xwzhx 재시작:8회
  - kube-system/kube-controller-manager-k8s-cp 재시작:6회
  - kube-system/kube-proxy-zst92 재시작:8회
  - kube-system/kube-scheduler-k8s-cp 재시작:6회
  - tigera-operator/tigera-operator-5d49548847-hc9lf 재시작:6회
